...
@RequestMapping(path = "/api/tipo-conta")
@Tag(name = "tipo conta", description = "documentação do resource tipo conta")
public class TipoContaResource implements IResource<TipoConta,Integer> {
    ...
    public TipoConta readById(@PathVariable Integer id) throws Exception {
        ...
        log.debug(String.format("Executado método TipoContaResource.read | valores: %d", id));
